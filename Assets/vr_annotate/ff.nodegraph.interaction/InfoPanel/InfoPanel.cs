...
namespace ff.nodegraph.interaction
{
    ...
    public class InfoPanel : Singleton<InfoPanel>
    {
        ...
        void Start()
        {
            _annotationInfoPanel = new AnnotationInfoPanel();
            _initialScale = transform.localScale;
            GestureManager gestureManager = GestureManager.Instance;
        ...
        void Update()
        {
            ...
            switch (_state)
            {
                ...
                case States.Opening:
                    ...
                    {
                        WorldCursor wc = WorldCursor.Instance;
                        transform.position = wc.GetPosition();
                        transform.rotation = wc.GetRotation();
                    }
                    break;
                case States.Open:
                    {
        ...
        private const float DISTANCE_FROM_CAMERA = 10.5f;
        ...
        private Vector3 PositionFromController
        {
            ...
            {
                WorldCursor wc = WorldCursor.Instance;
                _lastValidPosition = wc.GetPosition() + wc.LookAtDirection();
        ...
        private Quaternion RotationFromController
        {
            ...
            {
                WorldCursor wc = WorldCursor.Instance;
                var ea = wc.GetRotation().eulerAngles;
