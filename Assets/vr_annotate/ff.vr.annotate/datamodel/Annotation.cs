...
namespace ff.vr.annotate.datamodel
{
    ...
    public class Annotation
    {
        ...
        public Annotation(arannotate.Annotation a,Node node)
        {
            Person author = new Person();
            author.name = a.creator;
            author.email = "test@test.de";
            GeoCoordinate coord = new GeoCoordinate();
            coord.position = a.localPosition;
            coord.CalcLatLongFromPosition();

            author.id = a.creator;
            //this.TargetNode
            this.GUID = Guid.NewGuid();
            this.Author = author;
            this.CreatedAt = DateTime.Parse(a.creationDate);
            this.Text = a.description;
            this.TargetNodeName = node.NodePath;
            Debug.Log(this.TargetNodeName);
            this.RootNodeId = node.RootNode.NodePath;
            Debug.Log(this.RootNodeId);
            this.TargetNode = node;
            Debug.Log(this.TargetNode.NodePath);
            this.AnnotationPosition = coord;
